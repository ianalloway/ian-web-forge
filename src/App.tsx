            ...
            <Routes>
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title="Ankle recovery tracker"
                      path="/recovery"
                      description="Track post-ankle surgery recovery: daily pain, incision checks, ROM exercises, PT goals, symptom flags, and orthopedic appointment questions."
                      noIndex
                    />
                    <RecoveryTracker />
                  </>
