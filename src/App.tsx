...
const routes = [
  ...
  { path: "/sandpile", Component: Sandpile, seo: { title: "Abelian Sandpile — fractals & self-organized criticality", description: "Drop grains of sand: a cell with 4 or more topples one to each neighbor. The same trivial rule builds a fractal from a single pile and, under steady rain, self-organizes to a critical state where one grain can trigger an avalanche of any size." } },
