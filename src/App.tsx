...
const routes = [
  ...
  { path: "/sudoku", Component: Sudoku, seo: { title: "Sudoku Solver — watch backtracking search", description: "Watch a backtracking Sudoku solver think: it places digits that fit, hits dead ends, and backtracks (in red) to try again. Generate easy/medium/hard puzzles and step through or run the search at any speed." } },
