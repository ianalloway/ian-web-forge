...
const routes = [
  ...
  { path: "/terrain", Component: TerrainPage, seo: { title: "Fractal Terrain — diamond-square heightmaps", description: "Generate procedural terrain with the diamond-square algorithm: seed four corners, set each midpoint to its neighbors' average plus a shrinking random nudge, repeat. One recursive rule carves hill-shaded coastlines, ridges, and peaks — tune roughness and sea level live." } },
