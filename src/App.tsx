...
const routes = [
  ...
  { path: "/rsa", Component: Rsa, seo: { title: "RSA Playground — build a key and break it", description: "Pick two primes, watch RSA build a public/private keypair, encrypt and decrypt a number by modular exponentiation with the square-and-multiply ladder shown step by step — then factor the modulus to recover the private key and see exactly what large primes are protecting. Textbook RSA, for learning only." } },
