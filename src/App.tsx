...
const routes = [
  ...
  { path: "/kellysim", Component: KellySim, seo: { title: "Kelly Bankroll Simulator — full vs fractional Kelly", description: "Monte Carlo hundreds of bankrolls betting the same edge at quarter, half, full, and double Kelly. See the whole distribution on a log scale — median growth, 5th/95th percentiles, risk of ruin, and worst drawdown — and why full Kelly's volatility makes fractional staking the practical choice." } },
