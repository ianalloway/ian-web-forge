...
const routes = [
  ...
  { path: "/neuralnet", Component: NeuralNet, seo: { title: "Neural Network — watch a decision boundary learn", description: "A tiny 2·8·8·1 neural network trains by backpropagation on 2D toy datasets — blobs, circles, XOR, and spirals. Watch the decision boundary bend to fit the data in real time as gradient descent lowers the loss." } },
