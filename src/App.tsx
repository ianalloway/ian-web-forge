...
const routes = [
  ...
  { path: "/mandelbrot", Component: Mandelbrot, seo: { title: "Mandelbrot Set — infinite zoom explorer", description: "Explore the Mandelbrot set: z ↦ z² + c iterated, with smooth escape-time coloring and click-to-zoom into the infinitely detailed boundary. Interior points never escape; every other point is colored by how fast it flees to infinity." } },
