...
const routes = [
  ...
  { path: "/metaballs", Component: Metaballs, seo: { title: "Metaballs — marching-squares iso-contours", description: "Watch organic blobs merge and split as marching squares traces the iso-contour of their combined inverse-square field. Tune the ball count, threshold, and speed — drop the threshold and separate blobs reach out and fuse." } },
