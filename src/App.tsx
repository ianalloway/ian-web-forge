...
const routes = [
  ...
  { path: "/wator", Component: WatorPage, seo: { title: "Wa-Tor — predator-prey population cycles", description: "The classic Wa-Tor simulation: fish wander and breed while sharks hunt, breed, and starve without food. Watch the two populations chase each other in Lotka-Volterra boom-and-bust cycles on a toroidal ocean — tune breeding and starvation live." } },
