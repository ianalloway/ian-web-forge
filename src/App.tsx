...
const routes = [
  ...
  { path: "/poisson", Component: Poisson, seo: { title: "Poisson-Disk Sampling — blue noise, no clumping", description: "Watch Bridson's algorithm fill space with blue noise: points placed so none are closer than a set radius, yet with no large gaps. A background grid makes the neighbor test instant — the even spacing behind stippling, dithering, and object scattering." } },
