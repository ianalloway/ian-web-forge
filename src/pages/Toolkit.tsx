...
const SECTIONS: { id: string; title: string; blurb: string; icon: LucideIcon; tools: Tool[] }[] = [
  ...
  },
  {
    ...
    tools: [
      {
        name: 'line-shop-cli',
        description: 'Flatten h2h moneylines; CSV; demo fixture or The Odds API; optional Kelly.',
      ...
      },
      {
        ...
        description: 'Webhook alerts when American odds move past a threshold (Line Shock Index).',
  ...
  },
  {
    ...
    tools: [
      {
        name: 'model-cardgen',
        description: 'metrics.json → Markdown model cards & data cards.',
        url: 'https://github.com/ianalloway/model-cardgen',
        tags: ['MLOps', 'CLI'],
      },
      {
        name: 'agent-trace-kit',
        description: 'JSONL traces + static HTML replay for agent debugging.',
        url: 'https://github.com/ianalloway/agent-trace-kit',
        tags: ['agents', 'observability'],
      },
      {
        name: 'fraud-anomaly-bench',
        description: 'Sklearn benchmark harness + leaderboard pattern.',
        url: 'https://github.com/ianalloway/fraud-anomaly-bench',
        tags: ['benchmark'],
      },
      {
        name: 'substack-rag-local',
        description: 'Local RAG over Substack RSS (TF–IDF + Streamlit / CLI).',
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: 'Homebrew Bundle bootstrap for a clean dev Mac.',
...
const FLOW_STEPS = [
  ...
  { label: 'Line shop', href: 'https://github.com/ianalloway/line-shop-cli' },
