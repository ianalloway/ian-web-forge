...
const PROJECTS: Project[] = [
  {
    title: 'solvent-agent',
    description: 'Self-funding AI analyst: Stripe Payment Links, Checkout Session verification, Nemotron fulfilment, Issuing spend guardrails, live treasury P&L. Hermes Hackathon.',
    technologies: ['Python', 'Stripe', 'NVIDIA Nemotron', 'SQLite'],
    github: 'https://github.com/ianalloway/solvent-agent',
    demo: '/demos#solvent',
  ...
  },
  {
    ...
    github: `${OSS}/odds-drift-watch`,
    demo: `${OSS}/odds-drift-watch#readme`,
  ...
  {
    title: 'juryrig',
    description: 'Audit LLM-as-judge pipelines: position bias, verbosity bias, self-consistency, judge panels, calibration scoring. Zero dependencies.',
    technologies: ['Python', 'Evaluation', 'LLM Judges'],
    github: 'https://github.com/ianalloway/juryrig',
    demo: 'https://github.com/ianalloway/juryrig#readme',
  ...
  },
  {
    ...
    description: 'Read-only risk, proxy, and upgrade timeline scanner for Ethereum, Base, Optimism, and Arbitrum contracts.',
    technologies: ['Python', 'Web3', 'EVM', 'Security'],
    github: 'https://github.com/ianalloway/onchain-risk-scanner',
    demo: 'https://github.com/ianalloway/onchain-risk-scanner#readme',
  ...
  },
  {
    ...
    github: `${OSS}/backtest-report-gen`,
    demo: `${OSS}/backtest-report-gen#readme`,
  ...
  },
  {
    ...
    github: `${OSS}/metric-regression-gate`,
    demo: `${OSS}/metric-regression-gate#readme`,
  ...
  },
  {
    ...
    github: `${OSS}/stock-sentiment-analyzer`,
    demo: `${OSS}/stock-sentiment-analyzer#readme`,
  ...
  },
  {
    ...
    github: `${OSS}/macos-disk-cleanup`,
    demo: `${OSS}/macos-disk-cleanup#readme`,
  ...
  },
  {
    ...
    github: `${OSS}/code-stash`,
    demo: `${OSS}/code-stash#readme`,
  ...
  },
  {
    ...
    github: `${OSS}/repo-health`,
    demo: `${OSS}/repo-health#readme`,
